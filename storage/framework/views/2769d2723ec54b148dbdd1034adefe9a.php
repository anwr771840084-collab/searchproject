<?php $__env->startSection('title', 'البحث عن المفقودات'); ?>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <?php if(isset($posts) && $posts->count() > 0): ?>
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card post-preview-card mb-5 shadow-sm border-0 bg-white">
                            <?php if($post->image): ?>
                                <img src="<?php echo e(asset($post->image)); ?>" class="card-img-top post-card-img" alt="صورة المفقود">
                            <?php endif; ?>
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h2 class="card-title h4 mb-0 fw-bold"><?php echo e($post->name); ?></h2>
                                    <?php if($post->is_delivered): ?>
                                ...
                                <p class="card-text text-muted mb-4 fs-5" style="line-height: 1.6;"><?php echo e($post->massage); ?></p>
                                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center border-top pt-3 mt-3 gap-2">
                                    <div class="text-muted small">
                                        <i class="fas fa-user-circle me-1 text-primary"></i> بواسطة: <a href="#!" class="text-decoration-none text-muted"><?php echo e($post->email); ?></a>
                                    </div>
                                    <div class="text-muted small">
                                        <i class="fas fa-calendar-alt me-1 text-primary"></i> <?php echo e($post->created_at->format('d M Y')); ?>
                ...
                <!-- Pager-->
                <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="<?php echo e(url('/contact')); ?>">→ أبلغ عن الشيء المفقود </a></div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hp\Desktop\search-project\resources\views\index.blade.php ENDPATH**/ ?>