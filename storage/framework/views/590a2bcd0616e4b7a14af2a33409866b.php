<?php $__env->startSection("title", "layout-sidenav-light - SB Admin"); ?>
...
<tr>
    <td><?php echo e($db->name); ?></td>
     <td><?php echo e($db->email); ?></td>
     <td><?php echo e($db->phone); ?></td>
     <td><?php echo e($db->address); ?></td>
     <td>
        <?php if($db->image): ?>
            <img src="<?php echo e(asset($db->image)); ?>" alt="صورة الشيء المحصول" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px;">
        <?php else: ?>
            <span style="color: #999;">لا توجد صورة</span>
        <?php endif; ?>
     </td>
      <td><?php echo e($db->message); ?></td>
      <td>
        <?php if($db->is_delivered): ?>
      ...
      <td>
        <form action="<?php echo e(route('helps.toggle-delivery', $db->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <button type="submit" class="btn <?php echo e($db->is_delivered ? 'btn-danger' : 'btn-success'); ?> btn-sm text-white" style="border-radius: 20px; padding: 5px 15px;">
                <?php echo e($db->is_delivered ? 'إلغاء التسليم' : 'تسليم'); ?>
...
<?php echo $__env->make("layouts.master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hp\Desktop\search-project\resources\views\admin\layout-sidenav-light.blade.php ENDPATH**/ ?>