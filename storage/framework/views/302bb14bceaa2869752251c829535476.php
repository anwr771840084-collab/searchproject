                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="btn btn-primary" href="<?php echo e(route("password.email")); ?>">إعادة تعيين كلمة المرور</a>
                                                <a class="small" href="<?php echo e(route("accountlogin")); ?>">العودة لتسجيل الدخول</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?php echo e(route("register")); ?>">تحتاج لحساب؟ سجل الآن!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\hp\Desktop\search-project\resources\views\auth\password.blade.php ENDPATH**/ ?>