...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-form-section">
            ...
            <form id="login-frm" action="<?php echo e(route('login')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="username" placeholder="اسم المستخدم" value="<?php echo e(old('username')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="كلمة المرور" required>
...
<?php /**PATH C:\Users\hp\Desktop\search-project\resources\views\admin\login.blade.php ENDPATH**/ ?>