<?php $__env->startSection('title', 'البحث عن المفقودات - تواصل معنا'); ?>

<?php $__env->startSection('header'); ?>
    <!-- Page Header-->
    <header class="masthead" style="background-image: url("<?php echo e(asset('assets/img/contact-bg.jpg')); ?>")>
...
.masthead {
    background: linear-gradient(rgba(40, 167, 69, 0.85), rgba(23, 162, 184, 0.9)),
                url("<?php echo e(asset('assets/img/contact-bg.jpg')); ?>") no-repeat center center;
...
<?php $__env->startSection('content'); ?>
    <main class="mb-4">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <p>هاملأ النموذج أدناه لإرسال رسالتك وسنرد عليك في أقرب وقت ممكن!</p>
                    <div class="my-5">

                        <form id="contactForm" action="<?php echo e(url('/contact')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div>
                            ...
                            <div class="form-group mb-3">
                                <label for="image" class="form-label">صورة الشيء المفقود</label>
                                <div class="input-group">
    <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
    <input class="form-control" id="image" name="image" type="file" accept="image/*" />
</div>
                                <div class="form-text">يرجى إرفاق صورة واضحة للشيء المفقود للمساعدة في البحث  </div>
                            </div>
                            <div class="form-floating">
                                <textarea class="form-control" id="massage" name="massage" placeholder="أدخل رسالتك هنا..." style="height: 12rem" data-sb-validations="required"></textarea>
                                <label for="massage">الرسالة</label>
                                <div class="invalid-feedback" data-sb-feedback="massage:required">الرسالة مطلوبة.</div>
                            </div>
                            <br />
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hp\Desktop\search-project\resources\views/contact.blade.php ENDPATH**/ ?>