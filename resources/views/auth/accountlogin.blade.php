    ...
    <div class="auth-container">
        ...
        <div class="auth-form-section">
            ...
            <form id="login-frm" action="/accountlogin" method="post">
                ...
                @error('username')
                    <div class="text-danger mb-2" style="font-size: 0.875em;">{{ $message }}</div>
                @enderror
            ...
            <div class="login-link">
                <div class="small"><a href="{{ route("login") }}">لديك حساب؟ اذهب لتسجيل الدخول</a></div>
            </div>
        </div>
    </div>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
    @if(file_exists(public_path('js/scriptss.js' )))
