...
<html lang="ar" dir="rtl">
    <head>
        ...
        <title>@yield('title', 'مدونة نظيفة - قالب Start Bootstrap')</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
              <a class="navbar-brand" href="{{ url('/login') }}"><i class="fas fa-cogs"></i> الاداره</a>
...
<li class="nav-item">
    <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ url('/about') }}">
        <i class="fas fa-info-circle"></i>
        نبذه عنا
    </a>
</li>
<li class="nav-item">
    <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ url('/contact') }}">
        <i class="fas fa-search"></i>
        اخبرنا اذا فقدت شيء
    </a>
</li>
<li class="nav-item">
    <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ url('/help') }}">
